...
{
    private static readonly Dictionary<Type, string> _exceptionErrorCodes = new()
    {
    ...
    public static ResponseData<T> HandleException<T>(Exception ex)
    {
    ...
    private static string GetErrorCode(Exception ex)
    {
        ...
        if (_exceptionErrorCodes.TryGetValue(ex.GetType(), out var errorCode))
        {
            return errorCode;
        }
