...
const _nav = [
  ...
  {component:CNavItem, name:'Contact Us', to:'/contact'},
  {component:CNavItem, name:'Education', to :'/education'},
  {component:CNavItem, name :"Experiances" , to:'/experiance'},
  // {componenet:CNavItem, name:'Hero', to:'/hero'},
  {component:CNavItem, name :'portifolio', to:'/portifolio'},
  {component:CNavItem, name:'Services', to:'/service'},
  {component:CNavItem, name:'Skills', to:'/skills'},
  {
    component: CNavTitle,
    name: 'Theme',
  },
